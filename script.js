// Henter json filen //
fetch('https://aikon74.github.io/OppJsonfile/')
    .then(response => response.json())
    .then(data => {
        Object.assign(gameData, data); // Overfører data fra JSON til gameData
        resetGame(); // Starter spillet med data fra JSON
    })
    .catch(error => console.error('Kunne ikke laste JSON:', error));
